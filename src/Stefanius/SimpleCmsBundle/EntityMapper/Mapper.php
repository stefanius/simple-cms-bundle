...
class Mapper 
{
     ...
     */
    public function addNewMapping($className, $shortBundleName, $namespace, AbstractObjectManager $manager, $formTypeClassName = 'Stefanius\SimpleCmsBundle\Form\DynamicType')
    {
